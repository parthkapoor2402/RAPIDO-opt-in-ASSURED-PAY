...
export function HomePageContent() {
  ...
  return (
    <div className="space-y-4">
      ...
      <Link
        href="/booking"
        className="block rounded-2xl border border-surface-200 bg-white px-4 py-3 shadow-card"
        data-testid="home-destination-search"
      >
      ...
      <Link href="/booking">
        <CTAButton fullWidth>Plan your ride</CTAButton>
      </Link>
    </div>
  );
}
